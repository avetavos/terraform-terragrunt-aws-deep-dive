...
export const quizCicdPipeline = [
  ...
  },
  {
    ...
    options: [
      ...
      'ออก credential แบบ short-lived และ scope เฉพาะแต่ละ run โดยให้ CI system assume IAM role ผ่าน identity token ที่เชื่อถือได้ ไม่ต้องเก็บหรือ rotate AWS key แบบ long-lived ใน CI เลย',
